                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('kelompok-posyandu.update', $datas->kode_posyandu) }}" method="post">
                                        @csrf
                                        @method('PATCH')
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 pr-md-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="kode_posyandu" value="{{ $datas->kode_posyandu }}" class="form-control"
                                            ...
                                            <div class="col-md-6 pl-md-1">
                                                <div class="form-group">
                                                    ...
                                                    <input name="nama_posyandu" type="text" class="form-control"
                                                        placeholder="Nama Kelompok..." value="{{ $datas->nama_posyandu }}" autofocus>
                                                </div>
                                            </div>
                                        </div>
